 ...
 */
namespace DynamicOOOS\setasign\Fpdi\Tcpdf;

use DynamicOOOS\setasign\Fpdi\FpdiTrait;
use DynamicOOOS\setasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use DynamicOOOS\setasign\Fpdi\PdfParser\Filter\AsciiHex;
use DynamicOOOS\setasign\Fpdi\PdfParser\PdfParserException;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfHexString;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfNull;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfNumeric;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfStream;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfString;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfType;
use DynamicOOOS\setasign\Fpdi\PdfParser\Type\PdfTypeException;
/**
 * Class Fpdi
 *
 ...
 */
class Fpdi extends \DynamicOOOS\TCPDF
{
    use FpdiTrait {
    ...
    protected function writePdfType(PdfType $value)
    {
        ...
        if ($value instanceof PdfString) {
            ...
            $value->value = \DynamicOOOS\TCPDF_STATIC::_escape($string);
