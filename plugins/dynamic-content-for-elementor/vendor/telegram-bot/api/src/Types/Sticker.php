...
class Sticker extends BaseType implements TypeInterface
{
     ...
     * @var array
     */
    protected static $requiredParams = ['file_id', 'file_unique_id', 'type', 'width', 'height', 'is_animated', 'is_video'];
    /**
     * {@inheritdoc}
     *
     * @var array
     */
    protected static $map = ['file_id' => \true, 'file_unique_id' => \true, 'type' => \true, 'width' => \true, 'height' => \true, 'is_animated' => \true, 'is_video' => \true, 'thumb' => PhotoSize::class, 'file_size' => \true, 'premium_animation' => File::class, 'emoji' => \true, 'set_name' => \true, 'mask_position' => MaskPosition::class, 'custom_emoji_id' => \true];
    /**
