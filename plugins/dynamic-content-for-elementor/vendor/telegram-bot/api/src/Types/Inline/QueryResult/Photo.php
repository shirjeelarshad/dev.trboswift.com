...
class Photo extends AbstractInlineQueryResult
{
     ...
     * @var array
     */
    protected static $map = ['type' => \true, 'id' => \true, 'photo_url' => \true, 'thumb_url' => \true, 'photo_width' => \true, 'photo_height' => \true, 'title' => \true, 'description' => \true, 'caption' => \true, 'input_message_content' => InputMessageContent::class, 'reply_markup' => InlineKeyboardMarkup::class];
    /**
     * {@inheritdoc}
     *
     * @var string
     ...
     */
    public function __construct($id, $photoUrl, $thumbUrl, $photoWidth = null, $photoHeight = null, $title = null, $description = null, $caption = null, $inputMessageContent = null, $inlineKeyboardMarkup = null)
    {
