...
class Location extends AbstractInlineQueryResult
{
     ...
     * @var array
     */
    protected static $map = ['type' => \true, 'id' => \true, 'latitude' => \true, 'longitude' => \true, 'title' => \true, 'thumb_url' => \true, 'thumb_width' => \true, 'thumb_height' => \true, 'reply_markup' => InlineKeyboardMarkup::class, 'input_message_content' => InputMessageContent::class];
    /**
     * {@inheritdoc}
     *
     * @var string
     ...
     */
    public function __construct($id, $latitude, $longitude, $title, $thumbUrl = null, $thumbWidth = null, $thumbHeight = null, $inlineKeyboardMarkup = null, $inputMessageContent = null)
    {
