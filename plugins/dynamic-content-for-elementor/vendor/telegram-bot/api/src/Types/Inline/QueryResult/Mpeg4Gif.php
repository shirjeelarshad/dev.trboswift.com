...
class Mpeg4Gif extends AbstractInlineQueryResult
{
     ...
     * @var array
     */
    protected static $map = ['type' => \true, 'id' => \true, 'mpeg4_url' => \true, 'mpeg4_width' => \true, 'mpeg4_height' => \true, 'thumb_url' => \true, 'title' => \true, 'caption' => \true, 'reply_markup' => InlineKeyboardMarkup::class, 'input_message_content' => InputMessageContent::class];
    /**
     * {@inheritdoc}
     *
     * @var string
