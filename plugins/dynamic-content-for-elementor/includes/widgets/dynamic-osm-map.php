...
class DynamicOsmMap extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('addresses_list', ['label' => esc_html__('Addresses List', 'dynamic-content-for-elementor'), 'type' => \Elementor\Controls_Manager::REPEATER, 'fields' => $repeaters_address->get_controls(), 'default' => [['rep_address' => esc_html__($default_address, 'dynamic-content-for-elementor')]], 'title_field' => '{{{ rep_address }}}', 'condition' => ['map_data_type' => 'address']]);
        ...
        $repeaters_latlon->add_control('text_infowindow_latlon', ['label' => esc_html__('Info Window', 'dynamic-content-for-elementor'), 'frontend_available' => \true, 'type' => \Elementor\Controls_Manager::TEXT, 'default' => esc_html__('Text me', 'dynamic-content-for-elementor'), 'label_block' => \true, 'condition' => ['custom_infowindow_address' => 'yes']]);
