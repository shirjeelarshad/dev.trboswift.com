...
use ImportWP\Common\Importer\Template\PremiumPressTemplate;
...
class ImporterManager
{
    ...
    public function link_importer_file($id, $file_path)
    {
        ...
        update_post_meta($importer->getId(), '_importer_file_' . $index, addslashes($file_path));
    ...
    public function get_templates()
    {
        ...
        $templates = array_merge($templates, [
			...
			//'custom-post-type' => PremiumPressTemplate::class, 
