...
class Menu
{
    ...
    {
        $title = __('CSV Import', $this->properties->plugin_domain);

 
        $hook_suffix = add_menu_page('', '', 'activate_plugins', $this->properties->plugin_domain, array( $this->view_manager, 'plugin_page'  ), 1 );
