...
add_filter( 'ppt_admin_layouts',  array('at_style3b',  'data') );
add_filter( 'at_style3b',  array('at_style3b',  'load') );
...
class at_style3b {
	...
	public static function data($a){ 
		...
		$a['at_style3b'] = array(
			...
			"name" 	=> "Style 3",
			"image"	=> _ppt_demopath()."/designs/style3b.jpg",
...
$core['design']['color_primary'] = "#989898";
$core['design']['color_secondary'] = "#111111";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style3/hero2.jpg";     
