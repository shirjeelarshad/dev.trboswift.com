...
add_filter( 'ppt_admin_layouts',  array('at_compact5',  'data') );
add_filter( 'at_compact5',  array('at_compact5',  'load') );
...
class at_compact5 {
	...
	public static function data($a){ 
		...
		$a['at_compact5'] = array(
			...
			"name" 	=> "Compact 5",
			"image"	=> _ppt_demopath()."/designs/compact5.jpg",
...
$core['design']['color_primary'] = "#617e7f";
$core['design']['color_secondary'] = "#9db9ba";
        ...
        $core["home"]["image_basic1"]["image_block1"] = _ppt_demopath()."/compact/inline3.jpg";     
        $core["home"]["image_basic1"]["image_block1_effect"] = "2";     
        $core["home"]["image_basic1"]["image_block1_txtpos"] = "ccenter";     
        ...
        $core["home"]["image_basic1"]["image_block1_subtitle"] = "We have over 1,000+ Auctions online, right now!";     
        ...
        $core["home"]["image_basic1"]["image_block1_btn_bg"] = "primary";     
        $core["home"]["image_basic1"]["image_block1_btn_bg_txt"] = "text-light";     
