...
add_filter( 'ppt_admin_layouts',  array('at_style3a',  'data') );
add_filter( 'at_style3a',  array('at_style3a',  'load') );
...
class at_style3a {
	...
	public static function data($a){ 
		...
		$a['at_style3a'] = array(
			...
			"name" 	=> "Style 3",
			"image"	=> _ppt_demopath()."/designs/style3a.jpg",
...
$core['design']['color_primary'] = "#E01442";
$core['design']['color_secondary'] = "#111111";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style3/hero1.jpg";     
