...
add_filter( 'ppt_admin_layouts',  array('at_yard2',  'data') );
add_filter( 'at_yard2',  array('at_yard2',  'load') );
...
class at_yard2 {
	...
	public static function data($a){ 
		...
		$a['at_yard2'] = array(
			...
			"name" 	=> "Yard Sale 2",
			"image"	=> _ppt_demopath()."/designs/yard2.jpg",
			...
			"elementor" => array( 
				...
				"homepage" => __DIR__ ."/elementor-yard2-homepage.json",
