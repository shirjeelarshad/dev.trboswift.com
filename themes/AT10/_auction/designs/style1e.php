...
add_filter( 'ppt_admin_layouts',  array('at_style1e',  'data') );
add_filter( 'at_style1e',  array('at_style1e',  'load') );
...
class at_style1e {
	...
	public static function data($a){ 
		...
		$a['at_style1e'] = array(
			...
			"name" 	=> "Style 1e",
			"image"	=> _ppt_demopath()."/designs/style1e.jpg",
...
$core['design']['color_secondary'] = "#0c2b64";
        ...
        $core["home"]["hero_search1"]["title"] = "Online Auction Website";     
        $core["home"]["hero_search1"]["subtitle"] = "Find amazing items today!";     
        ...
        $core["home"]["hero_search1"]["title_txtcolor"] = "dark";     
        ...
        $core["home"]["hero_search1"]["hero_image"] = _ppt_demopath()."/style1/hero4.jpg";     
        ...
        $core["home"]["listings2"]["title"] = "NEWLY <i class='fal fa-paint-brush mx-2 text-primary'></i> ADDED";     
        ...
        $core["home"]["text2"]["title"] = "Welcome to <i class='fal fa-paint-brush ml-2 text-primary'></i> <span class='font-weight-bold text-uppercase'><u>Job</u>Board</span>";     
