...
add_filter( 'ppt_admin_layouts',  array('at_yard3',  'data') );
add_filter( 'at_yard3',  array('at_yard3',  'load') );
...
class at_yard3 {
	...
	public static function data($a){ 
		...
		$a['at_yard3'] = array(
			...
			"name" 	=> "Yard Sale 2",
			"image"	=> _ppt_demopath()."/designs/yard3.jpg",
			...
			"elementor" => array( 
				...
				"homepage" => __DIR__ ."/elementor-yard3-homepage.json",
