...
add_filter( 'ppt_admin_layouts',  array('at_style1d',  'data') );
add_filter( 'at_style1d',  array('at_style1d',  'load') );
...
class at_style1d {
	...
	public static function data($a){ 
		...
		$a['at_style1d'] = array(
			...
			"name" 	=> "fashion 4",
			"image"	=> _ppt_demopath()."/designs/style1d.jpg",
...
$core['design']['color_secondary'] = "#0c2b64";
        ...
        $core["home"]["hero_search2"]["title"] = "Online Auction Website";     
        $core["home"]["hero_search2"]["subtitle"] = "Amazing items for sale now!";     
        ...
        $core["home"]["hero_search2"]["title_margin"] = "mb-1";     
        $core["home"]["hero_search2"]["subtitle_margin"] = "mb-2";     
        $core["home"]["hero_search2"]["desc_margin"] = "mb-4";     
        ...
        $core["home"]["hero_search2"]["title_txtw"] = "font-weight-bold";     
        $core["home"]["hero_search2"]["subtitle_txtw"] = "font-weight-bold";     
        $core["home"]["hero_search2"]["btn_show"] = "yes";     
        $core["home"]["hero_search2"]["btn_link"] = "[link-search]";     
        $core["home"]["hero_search2"]["btn_txt"] = "View auctions";     
        $core["home"]["hero_search2"]["btn_bg"] = "light";     
        $core["home"]["hero_search2"]["btn_bg_txt"] = "text-dark";     
        $core["home"]["hero_search2"]["btn_icon"] = "fas fa-long-arrow-alt-right";     
        $core["home"]["hero_search2"]["btn_icon_pos"] = "after";     
        $core["home"]["hero_search2"]["btn_size"] = "btn-xl";     
        $core["home"]["hero_search2"]["btn_margin"] = "mt-5";     
        $core["home"]["hero_search2"]["btn_style"] = "3";     
        $core["home"]["hero_search2"]["btn_font"] = "";     
        $core["home"]["hero_search2"]["btn2_show"] = "no";     
        $core["home"]["hero_search2"]["hero_image"] = _ppt_demopath()."/style1/hero3.jpg";     
        ...
        $core["home"]["listings2"]["title"] = "FEATURED <i class='fal fa-paint-brush mx-2 text-primary'></i> AUCTIONS";     
        ...
        $core["home"]["icon8"]["section_bg"] = "bg-light";     
        ...
        $core["home"]["icon8"]["title"] = "POPULAR <i class='fal fa-paint-brush mx-2 text-primary'></i> CATEGORIES";     
        ...
        $core["home"]["listings2a"]["title"] = "NEWLY <i class='fal fa-paint-brush mx-2 text-primary'></i> ADDED";     
        ...
        $core["home"]["subscribe2"]["title"] = "STAY <i class='fal fa-paint-brush mx-2 text-primary'></i> UPDATED";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = _ppt_demopath()."/style1/hero1.jpg"; 		
