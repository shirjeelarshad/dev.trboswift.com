...
add_filter( 'ppt_admin_layouts',  array('at_yard1',  'data') );
add_filter( 'at_yard1',  array('at_yard1',  'load') );
...
class at_yard1 {
	...
	public static function data($a){ 
		...
		$a['at_yard1'] = array(
			...
			"name" 	=> "Yard Sale 1",
			"image"	=> _ppt_demopath()."/designs/yard1.jpg",
			...
			"elementor" => array( 
				...
				"homepage" => __DIR__ ."/elementor-yard1-homepage.json",
