...
add_filter( 'ppt_admin_layouts',  array('at_style3c',  'data') );
add_filter( 'at_style3c',  array('at_style3c',  'load') );
...
$core['design']['color_primary'] = "#ffd334";
$core['design']['color_secondary'] = "#111111";
        ...
        $core["home"]["hero_text1"]["hero_image"] = _ppt_demopath()."/style3/hero3.jpg";     
