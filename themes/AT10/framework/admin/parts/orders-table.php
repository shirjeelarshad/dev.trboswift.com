...
<div class="clearfix mb-4">
  <button type="button" onclick="jQuery('#add-tab').tab('show');"  class="<?php if($CORE->GEO("is_right_to_left", array() )){ echo "float-left"; }else{ echo "float-right"; } ?> btn btn-admin"> <span class="btn-label"><i class="fa fa-plus"></i></span> <?php echo __("Add Order","premiumpress"); ?></button>
  <h4 class="mt-4"><span class="ajax-search-found"></span> <?php echo __("Orders","premiumpress"); ?></h4></div>
