...
<div class="clearfix mb-4">
    ...
    <span class="btn-label"><i class="fa fa-plus"></i></span> <?php echo __("Add New","premiumpress"); ?></button>
     
    <h4 class="mt-4"><span class="ajax-search-found"></span> <?php echo __("Cashback Requests","premiumpress"); ?></h4>
    <div class="small text-muted"><?php echo __("Used only when a user makes a cashback requests.","premiumpress"); ?></div>
...
<div class="card card-admin p-4">  
    ...
    <div class="row mb-3">    
        ...
        <a href="javascript:void(0);" data-key="order_total"><span><?php echo __("Amount Paid","premiumpress"); ?><i></i></span></a>
