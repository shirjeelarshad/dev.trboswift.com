...
<div class="clearfix mb-4">
    ...
    <h4 class="mt-4"><span class="ajax-search-found"></span> <?php echo __("Cashout Requests","premiumpress"); ?></h4>
    <div class="small text-muted"><?php echo __("Used only when a user makes a cashout requests.","premiumpress"); ?></div>
