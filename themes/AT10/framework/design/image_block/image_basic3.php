...
add_filter( 'ppt_blocks_args',  	array('block_image_basic3',  'data') );
add_action( 'image_basic3',  		array('block_image_basic3', 'output' ) );
add_action( 'image_basic3-css',  	array('block_image_basic3', 'css' ) );

class block_image_basic3 {
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $settings = $CORE->LAYOUT("get_block_settings_defaults", array("image_basic3", "image_block", $settings ) );
...
<?php $i=1; while($i < 4){ ?>
<div class="col-sm-4 col-6 <?php if($i == 3){ ?>d-none d-md-block<?php } ?>">
