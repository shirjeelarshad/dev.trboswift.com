...
add_filter( 'ppt_blocks_args', 	array('block_text1a',  'data') );
add_action( 'text1a',  		array('block_text1a', 'output' ) );
add_action( 'text1a-css',  	array('block_text1a', 'css' ) );
add_action( 'text1a-js',  	array('block_text1a', 'js' ) );
	...
	public static function data($a){  global $CORE;
		...
		$a['text1a'] = array(
			...
			"data" 	=> array( ),
					...
					"text_image1" => DEMO_IMG_PATH."/innerpages/1.jpg"
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text1a", "text", $settings ) );
