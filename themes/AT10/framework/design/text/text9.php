...
add_filter( 'ppt_blocks_args', 	array('block_text9',  'data') );
add_action( 'text9',  		array('block_text9', 'output' ) );
add_action( 'text9-css',  	array('block_text9', 'css' ) );
add_action( 'text9-js',  	array('block_text9', 'js' ) );
...
class block_text9 {
	...
	$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text9", "text", $settings ) ); 
...
<section class="p-y-lg bg-edit content-dashboard content-align-md <?php echo $settings['section_class']." ".$settings['section_bg']." ".$settings['section_padding']." ".$settings['section_divider']; ?>">
            ...
            <div class="container">
                <div class="row y-middle d-flex flex-lg-row-reverse">    
                    ...
                    <div class="col-lg-5 align-middle text-center text-lg-left pb-5">
                     ...
                     <div class="col-lg-7 text-center m-b-md wow fadeInLeft"> 
                        <img data-src="<?php echo $settings['text_image1']; ?>" class="dash-left lazy" alt="d"> 
                    </div>
