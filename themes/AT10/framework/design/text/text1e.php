...
add_filter( 'ppt_blocks_args', 	array('block_text1e',  'data') );
add_action( 'text1e',  		array('block_text1e', 'output' ) );
add_action( 'text1e-css',  	array('block_text1e', 'css' ) );
add_action( 'text1e-js',  	array('block_text1e', 'js' ) );
	...
	public static function data($a){  global $CORE;
		...
		$a['text1e'] = array(
			...
			"defaults" => array(
					...
					"text_image1" => DEMO_IMG_PATH."/blocks/text/icons/user-2.png"
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text1e", "text", $settings ) );
		...
		if($settings['text_image1'] == ""){
			...
			$default_data = $CORE->LAYOUT("get_block_defaults", "text1e");		 	 
