...
add_filter( 'ppt_blocks_args', 	array('block_text17a',  'data') );
add_action( 'text17a',  		array('block_text17a', 'output' ) );
add_action( 'text17a-css',  	array('block_text17a', 'css' ) );
add_action( 'text17a-js',  	array('block_text17a', 'js' ) );
...
class block_text17a {
	...
	public static function data($a){  global $CORE;
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text17a", "text", $settings ) );
 ...
 <?php if(strlen($settings['text_image1']) > 5){ ?>
        ...
        <?php }else{ ?>
         ...
         <div class="bg-pattern" data-bg="<?php echo DEMO_IMG_PATH; ?>/blocks/text/icons/bg1.png" style="z-index:100; opacity:1;"></div>
