...
add_filter( 'ppt_blocks_args', 	array('block_text3',  'data') );
add_action( 'text3',  		array('block_text3', 'output' ) );
add_action( 'text3-css',  	array('block_text3', 'css' ) );
add_action( 'text3-js',  	array('block_text3', 'js' ) );
...
class block_text3 {
	...
	public static function data($a){  global $CORE;
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text3", "text", $settings ) );
...
<div class="container">
<div class="row">
<div class="col-md-12 col-lg-6 text-center text-md-left pr-lg-5">
  <?php _ppt_template( 'framework/design/parts/title' ); ?>
  <?php _ppt_template( 'framework/design/parts/btn' ); ?>
</div>
<div class="col-md-12 col-lg-6">
  <div class="row">
    <div class="col-md-6"> <img data-src="<?php echo $settings['text_image1']; ?>" alt="<?php echo strip_tags($settings['title']); ?>" class="img-fluid lazy"> </div>
    ...
    <?php } ?>
     <img data-src="<?php echo $settings['text_image2']; ?>" alt="<?php echo strip_tags($settings['title']); ?>" class="img-fluid lazy"> 
