...
add_filter( 'ppt_blocks_args', 	array('block_text1g',  'data') );
add_action( 'text1g',  		array('block_text1g', 'output' ) );
add_action( 'text1g-css',  	array('block_text1g', 'css' ) );
add_action( 'text1g-js',  	array('block_text1g', 'js' ) );
...
class block_text1g {
	...
	public static function data($a){  global $CORE;
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("text1g", "text", $settings ) );
