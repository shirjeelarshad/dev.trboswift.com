...
add_filter( 'ppt_blocks_args',  array('block_hero_text4',  'data') );
add_action( 'hero_text4',  			array('block_hero_text4', 'output' ) );
add_action( 'hero_text4-css',  		array('block_hero_text4', 'css' ) );
add_action( 'hero_text4-js',  		array('block_hero_text4', 'js' ) );

class block_hero_text4 {
	...
	public static function data($a){ 
		...
		$a['hero_text4'] = array(
			...
			"defaults" => array(
					...
					"subtitle"			=> "#1 Premium WordPress Theme",	
					...
					"hero_size" 		=> "hero-medium",
					"hero_image" 		=> DEMO_IMG_PATH."/blocks/hero/hero7_bg.jpg",
					"hero_overlay" 		=> "green", 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("hero_text4", "hero", $settings ) );
		...
		if($settings['hero_image'] == ""){
			...
			$default_data = $CORE->LAYOUT("get_block_defaults", "hero_text4");		 	 
		...
		?><section class="hero-text4 position-relative hero-default <?php echo $settings['hero_size']; ?> text-<?php echo $settings['hero_txtcolor']; ?>">
