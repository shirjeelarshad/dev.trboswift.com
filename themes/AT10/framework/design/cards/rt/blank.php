...
<div class="<?php echo $post->cardclass; ?>" <?php echo $post->carddata; ?>> <?php echo $post->image_formatted; ?>
  <div class="card-body position-relative border-top">
    ...
    <div class="card-bottom d-flex justify-content-between">
      <div class="pricetag-big mt-2 <?php echo $CORE->GEO("price_formatting",array()); ?>"><?php echo $post->price; ?></div>
      <?php if(strlen($post->city) > 0){ ?>
      <div class="mt-3 opacity-5 small pt-2"><?php echo $post->city; ?></div>
      <?php } ?>
    </div>
  </div>
</div>
