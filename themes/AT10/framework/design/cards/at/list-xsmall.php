...
<div class="<?php echo $post->cardclass; ?>" <?php echo $post->carddata; ?>>
  <div class="row no-gutters">
    <div class="col-lg-6 border-right"> <?php echo $post->image_formatted; ?> </div>
    <div class="col-lg-6">
      <div class="new-search-body">
        ...
        <div class="pricetag-big text-center text-md-left mt-3 <?php echo $CORE->GEO("price_formatting",array()); ?>"><?php if( !is_user_logged_in() || in_array('subscriber', $user_roles) || in_array('administator', $user_roles)  ) { echo $current_price + $auction_customer_price; }else{  echo $current_price; } ?></div>
      </div>
    </div>
  </div>
</div>
