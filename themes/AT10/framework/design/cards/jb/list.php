...
<div class="col-md-8 col-xl-10 col-lg-8 text-center text-md-left">
    ...
    <ul class="list-inline small opacity-5 hide-mobile">    	
         ...
         <li class="list-inline-item hide-mobile"><i class="fal fa-sync mr-2"></i> <?php echo do_shortcode('[JOBTYPE  limit=1]'); ?></li> 
...
<div class="col-md-4 col-xl-2 col-lg-4 text-center text-lg-right">
    ...
    <div class="tiny text-uppercase opacity-5 hide-mobile hide-ipad"><?php echo do_shortcode('[SALARYTYPE]'); ?></div>
