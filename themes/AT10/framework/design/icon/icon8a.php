...
add_filter( 'ppt_blocks_args', 	array('block_icon8a',  'data') );
add_action( 'icon8a',  		array('block_icon8a', 'output' ) );
add_action( 'icon8a-css',  	array('block_icon8a', 'css' ) );
add_action( 'icon8a-js',  	array('block_icon8a', 'js' ) );
...
class block_icon8a {
	...
	public static function data($a){  global $CORE; 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("icon8a", "icon", $settings ) ); 
