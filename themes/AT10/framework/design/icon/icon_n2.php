...
add_filter( 'ppt_blocks_args', 	array('block_icon_n2',  'data') );
add_action( 'icon_n2',  		array('block_icon_n2', 'output' ) );
add_action( 'icon_n2-css',  	array('block_icon_n2', 'css' ) );
add_action( 'icon_n2-js',  	array('block_icon_n2', 'js' ) );
...
class block_icon_n2 {
	...
	public static function data($a){  global $CORE; 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("icon_n2", "icon", $settings ) ); 
   ...
   <div class="col-12">
      <div class="row">
         ...
         <div class="col-md-4">
               ...
               <div class="card card-shadow mb-4 mb-md-0">
