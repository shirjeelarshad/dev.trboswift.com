...
add_filter( 'ppt_blocks_args', 	array('block_icon_n3',  'data') );
add_action( 'icon_n3',  		array('block_icon_n3', 'output' ) );
add_action( 'icon_n3-css',  	array('block_icon_n3', 'css' ) );
add_action( 'icon_n3-js',  	array('block_icon_n3', 'js' ) );
...
class block_icon_n3 {
	...
	public static function data($a){  global $CORE; 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("icon_n3", "icon", $settings ) ); 
		...
		if($settings['icon1_title'] == ""){		
			$default_data = $CORE->LAYOUT("get_block_defaults", "icon_n3");
   ...
   <div class="col-12">
      <div class="row">
         ...
         <div class="col-md-4">
               ...
               <div class="card  mb-4 mb-md-0" style="border-top:3px solid <?php if($i == 1){ echo '#1274e7'; }elseif($i == 2){ echo '#00c853'; }else{ echo '#ff9800'; } ?>">
