...
add_filter( 'ppt_blocks_args',  	array('block_intro_6',  'data') );
add_action( 'intro_6',  		array('block_intro_6', 'output' ) );
add_action( 'intro_6-css',  	array('block_intro_6', 'css' ) );
add_action( 'intro_6-js',  	array('block_intro_6', 'js' ) );
...
class block_intro_6 {
	...
	public static function data($a){ 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("intro_6", "hero", $settings ) );
		...
		if($settings['hero_image'] == ""){
			...
			$default_data = $CORE->LAYOUT("get_block_defaults", "intro_6");		 	 
...
<header class="elementor_header header7 bg-white b-bottom">
  ...
  <section class="hero-demo hero-text1 position-relative hero-default hero-large text-<?php echo $settings['hero_txtcolor']; ?> text-<?php echo $settings['title_pos']; ?>">
        ...
        <div class="row justify-content-start">
         ...
         <?php _ppt_template( 'framework/design/parts/title' ); ?>
           ...
           <div class="mt-5">
            ...
            <a href="<?php echo _ppt(array('links','myaccount')); ?>" class="btn rounded-0 btn-xl btn-light  mt-0  btn-icon icon-before shadow"> <i class="mr-1 fa fa-user"></i> <span><?php echo __("My Account","premiumpress"); ?></span> </a>
            <?php }else{ ?>
            ...
            <div class="row">
            <div class="col-md-6">
              <a href="#" onclick="processRegister();" class="btn rounded-0  btn-xl btn-light  mt-0  btn-icon icon-before btn-block mb-4 shadow"> <i class="mr-1 fa fa-user"></i> <span><?php echo __("Join Now","premiumpress"); ?></span> </a>
            </div>
            <div class="col-md-6">
              <a href="#" onclick="processLogin();" class="btn rounded-0  btn-xl btn-light  mt-0  btn-icon icon-before btn-block shadow"> <i class="mr-1 fa fa-lock"></i> <span><?php echo __("Login","premiumpress"); ?></span> </a>
            </div>
            </div>
