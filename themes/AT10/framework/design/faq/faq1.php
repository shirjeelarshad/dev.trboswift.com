...
add_filter( 'ppt_blocks_args', 	array('block_faq1',  'data') );
add_action( 'faq1',  		array('block_faq1', 'output' ) );
add_action( 'faq1-css',  	array('block_faq1', 'css' ) );
add_action( 'faq1-js',  	array('block_faq1', 'js' ) );
...
class block_faq1 {
	...
	public static function data($a){ global $CORE; 
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("faq1", "faq", $settings ) ); 
