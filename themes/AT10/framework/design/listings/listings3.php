  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <?php } ?>
        <div  class="owl-carousel owl-theme"> <?php echo str_replace("data-srcxx","srcxx", do_shortcode('[LISTINGS dataonly=1 nav=0 small=1 carousel=1 '.$settings['datastring'].' ]'));  ?> </div>
      </div>
    </div>
  </div>
</section>
