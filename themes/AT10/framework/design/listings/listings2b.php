...
add_filter( 'ppt_blocks_args', 	array('block_listings2b',  'data') );
add_action( 'listings2b',  		array('block_listings2b', 'output' ) );
//add_action( 'listings2b-css',  	array('block_listings2b', 'css' ) );
//add_action( 'listings2b-js',  	array('block_listings2b', 'js' ) );

class block_listings2b {
	...
	public static function data($a){ global $CORE;  
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("listings2b", "listings", $settings ) ); 
