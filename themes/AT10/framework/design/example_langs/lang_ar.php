...
add_filter( 'ppt_admin_layouts',  array('lang_ar',  'data') );
add_filter( 'lang_ar',  array('lang_ar',  'load') );
...
class lang_ar {
	...
	public static function data($a){ 
		...
		$a['lang_ar'] = array(
			...
			"name" 	=> "Arabic",
			"image"	=> DEMO_IMG_PATH."/example_langs/ar0.jpg",
	...
	$core['design']['textlogo'] = "<i class='fal fa-globe-europe ml-2 text-primary'>&nbsp;</i> موقع الويب الخاص بي";  
...
$core['design']['color_primary'] = "#212843";
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["header"]["header7"]["btn_txt"] = "نشر إعلان";     
        ...
        $core["home"]["hero_text1"]["title"] = "مرحبا بكم في موقعنا الجديد";     
        $core["home"]["hero_text1"]["subtitle"] = "هذا مثال للتخطيط";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "البحث في الموقع";     
        ...
        $core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_ar.jpg";     
        ...
        $core["home"]["text1"]["title"] = "أهلا في موقعنا!";     
        $core["home"]["text1"]["subtitle"] = "لدينا بالضبط ما تبحث عنه!";     
        $core["home"]["text1"]["desc"] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.";    
			$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/ar1.jpg";    
        ...
        $core["home"]["text1"]["btn_txt"] = "البحث في الموقع";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "دخول الأعضاء";     
        ...
        $core["home"]["cta1a"]["title"] = "أهلا في موقعنا!";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "البحث في الموقع";     
        ...
        $core["home"]["subscribe2"]["title"] = "اشترك في النشرة الإخبارية";     
        $core["home"]["subscribe2"]["subtitle"] = "ابق على اطلاع بآخر الأخبار";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/ar2.jpg";  			
