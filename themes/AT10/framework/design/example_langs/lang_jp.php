...
add_filter( 'ppt_admin_layouts',  array('lang_jp',  'data') );
add_filter( 'lang_jp',  array('lang_jp',  'load') );
...
class lang_jp {
	...
	public static function data($a){ 
		...
		$a['lang_jp'] = array(
			...
			"name" 	=> "Japanese",
			"image"	=> DEMO_IMG_PATH."/example_langs/jp0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["header"]["header7"]["btn_txt"] = "ポスト広告";     
        ...
        $core["home"]["hero_text1"]["title"] = "新しいウェブサイトへようこそ！";     
        $core["home"]["hero_text1"]["subtitle"] = "これはレイアウトの例です。";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "ウェブサイトを検索";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_jp.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "私たちのウェブサイトへようこそ！";     
        $core["home"]["text1"]["subtitle"] = "私たちはあなたが探しているものを正確に持っています！";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/jp1.jpg";   
        ...
        $core["home"]["text1"]["btn_txt"] = "ウェブサイトを検索";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "会員ログイン";     
        ...
        $core["home"]["cta1a"]["title"] = "私たちのウェブサイトへようこそ！";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "ウェブサイトを検索";     
        ...
        $core["home"]["subscribe2"]["title"] = "ニュースレターに参加";     
        $core["home"]["subscribe2"]["subtitle"] = "最新のニュースで更新を続ける";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/jp2.jpg";  		
