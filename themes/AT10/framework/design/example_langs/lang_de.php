...
add_filter( 'ppt_admin_layouts',  array('lang_de',  'data') );
add_filter( 'lang_de',  array('lang_de',  'load') );
...
class lang_de {
	...
	public static function data($a){ 
		...
		$a['lang_de'] = array(
			...
			"name" 	=> "German",
			"image"	=> DEMO_IMG_PATH."/example_langs/de0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["header"]["header7"]["btn_txt"] = "Neuer Beitrag";     
        ...
        $core["home"]["hero_text1"]["title"] = "Willkommen in unserem neue Website!";     
        $core["home"]["hero_text1"]["subtitle"] = "Dies ist ein Beispiellayout.";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "Website durchsuchen";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_de.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "Willkommen auf unserer Webseite!";     
        $core["home"]["text1"]["subtitle"] = "Wir haben genau das, wonach Sie suchen!";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/de1.jpg";   
        ...
        $core["home"]["text1"]["btn_txt"] = "Website durchsuchen";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "Login für Mitglieder";     
        ...
        $core["home"]["cta1a"]["title"] = "Willkommen auf unserer Webseite!";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "Website durchsuchen";     
        ...
        $core["home"]["subscribe2"]["title"] = "NEWSLETTER BEITRETEN";     
        $core["home"]["subscribe2"]["subtitle"] = "Bleiben Sie mit den neuesten Nachrichten aktualisiert.";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/de2.jpg";  		
