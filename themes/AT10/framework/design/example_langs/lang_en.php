...
add_filter( 'ppt_admin_layouts',  array('lang_en',  'data') );
add_filter( 'lang_en',  array('lang_en',  'load') );
...
class lang_en {
	...
	public static function data($a){ 
		...
		$a['lang_en'] = array(
			...
			"name" 	=> "English",
			"image"	=> DEMO_IMG_PATH."/example_langs/en0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["home"]["hero_text1"]["title"] = "Welcome to our <br> new website!";     
        $core["home"]["hero_text1"]["subtitle"] = "This is an example layout.";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_en.jpg";  		
        ...
        $core["home"]["text1"]["subtitle"] = "We've got exactly what you're looking for!";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/en1.jpg";    
        ...
        $core["home"]["cta1a"]["title"] = "My text here";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "Search Website";     
        ...
        $core["home"]["subscribe2"]["title"] = "JOIN NEWSLETTER";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/en2.jpg"; 		
