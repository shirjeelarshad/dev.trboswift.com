...
add_filter( 'ppt_admin_layouts',  array('lang_es',  'data') );
add_filter( 'lang_es',  array('lang_es',  'load') );
...
class lang_es {
	...
	public static function data($a){ 
		...
		$a['lang_es'] = array(
			...
			"name" 	=> "Spanish",
			"image"	=> DEMO_IMG_PATH."/example_langs/es0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["header"]["header7"]["btn_txt"] = "PUBLICAR ANUNCIO";     
        ...
        $core["home"]["hero_text1"]["title"] = "Bienvenido a nuestro nuevo sitio web!";     
        $core["home"]["hero_text1"]["subtitle"] = "Este es un diseño de ejemplo.";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "Buscar sitio web";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_ru.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "Bienvenido a nuestro sitio web!";     
        $core["home"]["text1"]["subtitle"] = "Tenemos exactamente lo que estás buscando!";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/ru1.jpg";   
        ...
        $core["home"]["text1"]["btn_txt"] = "Buscar sitio web";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "Acceso de miembro";     
        ...
        $core["home"]["cta1a"]["title"] = "Bienvenido a nuestro sitio web!";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "Buscar sitio web";     
        ...
        $core["home"]["subscribe2"]["title"] = "ÚNASE AL BOLETÍN";     
        $core["home"]["subscribe2"]["subtitle"] = "MANTENTE ACTUALIZADO CON LAS ÚLTIMAS NOTICIAS";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/ru2.jpg";  		
