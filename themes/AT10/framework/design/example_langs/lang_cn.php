...
add_filter( 'ppt_admin_layouts',  array('lang_cn',  'data') );
add_filter( 'lang_cn',  array('lang_cn',  'load') );
...
class lang_cn {
	...
	public static function data($a){ 
		...
		$a['lang_cn'] = array(
			...
			"name" 	=> "Chinese",
			"image"	=> DEMO_IMG_PATH."/example_langs/cn0.jpg",
	...
	$core['design']['textlogo'] = "<i class='fal fa-globe-europe ml-2 text-primary'>&nbsp;</i> <span class='font-weight-bold text-primary'>我的</span> 网站";  
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["header"]["header7"]["btn_txt"] = "首页";     
        ...
        $core["home"]["hero_text1"]["title"] = "欢迎来到我们的新网站";     
        $core["home"]["hero_text1"]["subtitle"] = "这是一个示例布局";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "搜索网站";     
        ...
        $core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_cn.jpg";      
        ...
        $core["home"]["text1"]["title"] = "欢迎来到我们的新网站！";     
        $core["home"]["text1"]["subtitle"] = "我们已经完全满足您的需求！";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/cn1.jpg";     
        ...
        $core["home"]["cta1a"]["title"] = "欢迎来到我们的新网站";     
        ...
        $core["home"]["subscribe2"]["title"] = "加入时事通讯";     
        $core["home"]["subscribe2"]["subtitle"] = "保持最新消息";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/cn2.jpg";  		
