...
add_filter( 'ppt_admin_layouts',  array('lang_it',  'data') );
add_filter( 'lang_it',  array('lang_it',  'load') );
...
class lang_it {
	...
	public static function data($a){ 
		...
		$a['lang_it'] = array(
			...
			"name" 	=> "Italian",
			"image"	=> DEMO_IMG_PATH."/example_langs/it0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["home"]["hero_text1"]["title"] = "Benvenuti nel nostro nuovo sito web!";     
        $core["home"]["hero_text1"]["subtitle"] = "Questo è un esempio di layout.";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "Ricerca";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_it.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "Benvenuti sul nostro sito web!";     
        $core["home"]["text1"]["subtitle"] = "Abbiamo esattamente quello che stai cercando!";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/it1.jpg";   
        ...
        $core["home"]["text1"]["btn_txt"] = "Ricerca";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "Accesso membri";     
        ...
        $core["home"]["cta1a"]["title"] = "Benvenuti sul nostro sito web!";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "Ricerca";     
        ...
        $core["home"]["subscribe2"]["title"] = "ISCRIVITI ALLA NEWSLETTER";     
        $core["home"]["subscribe2"]["subtitle"] = "SOGGIORNO AGGIORNATO CON LE ULTIME NOVITÀ";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/it2.jpg";  		
