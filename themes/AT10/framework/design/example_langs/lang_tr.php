...
add_filter( 'ppt_admin_layouts',  array('lang_tr',  'data') );
add_filter( 'lang_tr',  array('lang_tr',  'load') );
...
class lang_tr {
	...
	public static function data($a){ 
		...
		$a['lang_tr'] = array(
			...
			"name" 	=> "Turkish",
			"image"	=> DEMO_IMG_PATH."/example_langs/tr0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["home"]["hero_text1"]["title"] = "Добро пожаловать в наш новый сайт!";     
        $core["home"]["hero_text1"]["subtitle"] = "Это пример макета.";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "Поиск по сайту";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_tr.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "Добро пожаловать на наш сайт!";     
        $core["home"]["text1"]["subtitle"] = "У нас есть именно то, что вы ищете!";     
        ...
        $core["home"]["text1"]["btn_txt"] = "Поиск по сайту";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "Логин участника";     
        ...
        $core["home"]["cta1a"]["title"] = "Добро пожаловать на наш сайт!";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "Поиск по сайту";     
        ...
        $core["home"]["subscribe2"]["title"] = "ПРИСОЕДИНИТЬСЯ К БЮЛЛЕТЕНЮ";     
        $core["home"]["subscribe2"]["subtitle"] = "Оставайтесь в курсе последних новостей";     
