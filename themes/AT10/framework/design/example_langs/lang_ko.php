...
add_filter( 'ppt_admin_layouts',  array('lang_ko',  'data') );
add_filter( 'lang_ko',  array('lang_ko',  'load') );
...
class lang_ko {
	...
	public static function data($a){ 
		...
		$a['lang_ko'] = array(
			...
			"name" 	=> "Korean",
			"image"	=> DEMO_IMG_PATH."/example_langs/ko0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["header"]["header7"]["btn_txt"] = "광고 후";     
        ...
        $core["home"]["hero_text1"]["title"] = "우리에 오신 것을 환영합니다새로운 웹 사이트!";     
        $core["home"]["hero_text1"]["subtitle"] = "이것은 레이아웃 예입니다.";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "웹 사이트 검색";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_ko.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "우리의 웹 사이트에 오신 것을 환영합니다!";     
        $core["home"]["text1"]["subtitle"] = "우리는 당신이 찾고있는 것을 정확하게 가지고 있습니다!";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/ko1.jpg";   
        ...
        $core["home"]["text1"]["btn_txt"] = "웹 사이트 검색";     
        ...
        $core["home"]["text1"]["btn2_txt"] = "회원 로그인";     
        ...
        $core["home"]["cta1a"]["title"] = "당신의 글은 여기에";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "웹 사이트 검색";     
        ...
        $core["home"]["subscribe2"]["title"] = "뉴스 레터 가입";     
        $core["home"]["subscribe2"]["subtitle"] = "최신 뉴스로 업데이트";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/ko2.jpg";  		
