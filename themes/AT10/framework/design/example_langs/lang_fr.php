...
add_filter( 'ppt_admin_layouts',  array('lang_fr',  'data') );
add_filter( 'lang_fr',  array('lang_fr',  'load') );
...
class lang_fr {
	...
	public static function data($a){ 
		...
		$a['lang_fr'] = array(
			...
			"name" 	=> "French",
			"image"	=> DEMO_IMG_PATH."/example_langs/fr0.jpg",
...
$core['design']['color_secondary'] = "#fdb819";
        ...
        $core["home"]["hero_text1"]["title"] = "Bienvenue sur notre nouveau site Internet!";     
        $core["home"]["hero_text1"]["subtitle"] = "Ceci est un exemple de disposition.";     
        ...
        $core["home"]["hero_text1"]["btn_txt"] = "Chercher";     
		...
		$core["home"]["hero_text1"]["hero_image"] = DEMO_IMG_PATH."/example_langs/hero_fr.jpg";  	
        ...
        $core["home"]["text1"]["title"] = "Bienvenue sur notre site!";     
        $core["home"]["text1"]["subtitle"] = "Nous avons exactement ce que vous cherchez!";     
		...
		$core["home"]["text1"]["text_image1"] = DEMO_IMG_PATH."/example_langs/fr1.jpg";   
        ...
        $core["home"]["text1"]["btn_txt"] = "Chercher";     
        ...
        $core["home"]["cta1a"]["title"] = "Bienvenue sur notre site!";     
        ...
        $core["home"]["cta1a"]["btn_txt"] = "Chercher";     
        ...
        $core["home"]["subscribe2"]["title"] = "REJOIGNEZ LA NEWSLETTER";     
        $core["home"]["subscribe2"]["subtitle"] = "RESTEZ MIS À JOUR AVEC LES DERNIÈRES NOUVELLES";     
        ...
        $core["home"]["subscribe2"]["image_subscribe"] = DEMO_IMG_PATH."/example_langs/fr2.jpg";  		
