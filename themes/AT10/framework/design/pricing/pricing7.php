...
.price-table-style-5 .price-icon {display: inline-block;margin-bottom: 30px;position: relative;height: 70px;width: 70px;line-height: 70px;padding: 10px;border-radius: 50px;background: <?php echo _ppt(array('design','color_primary')); ?>;-webkit-box-shadow: 0px 0px 0px 8px rgba(55, 99, 234, 0.2);box-shadow: 0px 0px 0px 8px rgba(55, 99, 234, 0.2);}
...
.price-table-style-5 .price-text h4 {font-size: 28px;font-weight: 700;margin-bottom: 0;color: <?php echo _ppt(array('design','color_primary')); ?>;}
...
.price-table-style-5 .primary-button {padding: 10px 30px;display: inline-block;text-transform: uppercase;text-align: center;font-weight: 500;border-radius: 5px;background: <?php echo _ppt(array('design','color_primary')); ?>;color: #fff;-webkit-transition: all 0.25s linear;transition: all 0.25s linear;-webkit-box-shadow: 0 5px 20px 0 rgba(55, 99, 234, 0.3);box-shadow: 0 5px 20px 0 rgba(55, 99, 234, 0.3);}
.price-table-style-5 .primary-button:hover {background: <?php echo _ppt(array('design','color_primary')); ?>;color: #fff;-webkit-box-shadow: 0 10px 20px 0 rgba(55, 99, 234, 0.4);box-shadow: 0 10px 20px 0 rgba(55, 99, 234, 0.4);-webkit-transform: translateY(-5px);transform: translateY(-5px);}
...
.price-table-style-5.active {background: <?php echo _ppt(array('design','color_primary')); ?>;}
...
.price-table-style-5.active .price-icon i {color: <?php echo _ppt(array('design','color_primary')); ?>}
