...
.price-table-style-6 .price-title h4 {text-transform: uppercase;font-size: 14px;font-weight: 400;margin-bottom: 0px;color: <?php echo _ppt(array('design','color_primary')); ?>;}
...
.price-table-style-6 .price-list li i {margin-right: 7px;height: 15px;width: 15px;font-size: 12px;line-height: 13px;text-align: center;border-radius: 50%;color: <?php echo _ppt(array('design','color_primary')); ?>;border: 1px solid <?php echo _ppt(array('design','color_primary')); ?>;}
.price-table-style-6 .primary-button {padding: 10px 30px;display: inline-block;text-transform: uppercase;text-align: center;font-weight: 500;border-radius: 30px;background: #f5f8fa;color: <?php echo _ppt(array('design','color_primary')); ?>;-webkit-transition: all 0.25s linear;transition: all 0.25s linear;-webkit-box-shadow: 0 5px 20px 0 rgba(55, 99, 234, 0.3);box-shadow: 0 5px 20px 0 rgba(55, 99, 234, 0.3);}
.price-table-style-6 .primary-button:hover {background: #f5f8fa;color: <?php echo _ppt(array('design','color_primary')); ?>;-webkit-box-shadow: 0 10px 20px 0 rgba(55, 99, 234, 0.4);box-shadow: 0 10px 20px 0 rgba(55, 99, 234, 0.4);-webkit-transform: translateY(-5px);transform: translateY(-5px);}
.price-table-style-6.active .primary-button {padding: 10px 30px;display: inline-block;text-transform: uppercase;text-align: center;border-radius: 30px;background: <?php echo _ppt(array('design','color_primary')); ?>;color: #fff;-webkit-transition: all 0.25s linear;transition: all 0.25s linear;-webkit-box-shadow: 0 5px 20px 0 rgba(72, 95, 183, 0.3);box-shadow: 0 5px 20px 0 rgba(72, 95, 183, 0.3);}
.price-table-style-6.active .primary-button:hover {background: <?php echo _ppt(array('design','color_primary')); ?>;color: #fff;-webkit-box-shadow: 0 10px 20px 0 rgba(72, 95, 183, 0.4);box-shadow: 0 10px 20px 0 rgba(72, 95, 183, 0.4);-webkit-transform: translateY(-5px);transform: translateY(-5px);}
.price-table-style-6.active {border-color: <?php echo _ppt(array('design','color_primary')); ?>;}
...
.price-table-style-6.active .price-icon i {color: <?php echo _ppt(array('design','color_primary')); ?>}
.price-table-style-6.active .price-table-head {background: <?php echo _ppt(array('design','color_primary')); ?>;}
