...
<div class="container">
  <div class="row">
    <div class="col-12"> <a href="<?php echo home_url(); ?>/?s=" class="btn btn-system btn-sm float-right mt-4 hide-mobile"><i class="fal fa-search mr-2 text-primary"></i> <?php echo __("See all","premiumpress"); ?></a>
      <h5 class="card-title my-4"><?php echo __("Ending soon","premiumpress"); ?></h5>
