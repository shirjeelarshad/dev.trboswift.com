...
<div class="sidebar-fixed-content">
 ...
 <?php if(in_array(_ppt(array('design','display_offers')), array("","1")) && in_array(get_user_meta($userdata->ID,'user_type',true),array("","user_fr")) ){ ?>
    
      <a href="javascript:void(0);" onclick="processMakeOffer();" class="btn btn-block btn-system shadow-sm btn-xl btn-icon icon-before mt-2 mb-3"> <i class="fal fa-briefcase text-primary"></i> <span><?php echo $CORE->LAYOUT("captions","offerbtn"); ?></span></a>
      ...
      <div class="extra-modal-wrap shadow hidepage" style="display:none;">
        ...
        <div class="extra-modal-item">
          <div class="extra-modal-container">
            <div class="card-body">
              <?php _ppt_template( 'framework/design/singlenew/blocks/sidebar-jb-offer' );  ?>
            </div>
